...
output_dir="${OUTPUT_DIR:-/mnt/vepfs02/output/kevin.wang/memorywam/train/control_information_v3_k8_putback_e2e_40k_seed42}"
...
export CONTROL_INFORMATION_OUTPUT="${output_dir}"
...
resolved_config="$("${runtime_bin}/python" scripts/train.py task=rmbench_putback_control_information_k8_40k --cfg job)"
...
echo "task=rmbench_putback_control_information_k8_40k"
echo "max_steps=40000"
echo "memory_tokens=8 minimum_history_frames=1"
echo "checkpoint_steps=5000,10000,15000,20000,25000,30000,35000,40000"
echo "save_training_state_every=10000"
...
accelerate launch \
  ...
  --num_processes 8 \
  scripts/train.py task=rmbench_putback_control_information_k8_40k
