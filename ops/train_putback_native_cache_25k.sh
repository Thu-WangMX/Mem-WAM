...
output_dir="${OUTPUT_DIR:-/mnt/vepfs02/output/kevin_wang/memorywam/train/layerwise_block_memory_putback_e2e_25k_seed42}"
...
export NATIVE_CACHE_25K_OUTPUT="${output_dir}"
...
cd "${repo_root}"
resolved_config="$("${runtime_bin}/python" scripts/train.py task=rmbench_putback_native_cache_25k --cfg job)"
...
echo "task=rmbench_putback_native_cache_25k"
