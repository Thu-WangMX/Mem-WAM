...
source_checkpoint="${SOURCE_CHECKPOINT:-/mnt/vepfs02/output/kevin_wang/memorywam/train/fastwam_memorywam_fullkv_putback_rgb_v3_b1x8_2k_seed42_20260731_v2/checkpoints/weights/step_002000.pt}"
output_dir="${OUTPUT_DIR:-/mnt/vepfs02/output/kevin_wang/memorywam/train/fastwam_fullkv_putback_rgb_v3_resume2k_extra3k_total5k_seed42_20260801}"
