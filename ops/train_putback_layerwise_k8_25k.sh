...
export LAYERWISE_K8_25K_OUTPUT="${output_dir}"
...
cd "${repo_root}"
resolved_config="$("${runtime_bin}/python" scripts/train.py task=rmbench_putback_layerwise_k8_25k --cfg job)"
...
echo "task=rmbench_putback_layerwise_k8_25k"
